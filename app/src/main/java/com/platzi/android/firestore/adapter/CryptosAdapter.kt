...
//this will be the adapter of our recycler view
class CryptosAdapter(val cryptosAdapterListener: CryptosAdapterListener): RecyclerView.Adapter<CryptosAdapter.ViewHolder>() {
//adding : RecyclerView..... we are inheriting the class RecyclerView methods and elements
    var cryptoList: List<Crypto> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        //it creates and initializes the ViewHolder with its asotiated view, but without the view contents, it is
        //yet to link with specific data.
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        //this shows the cryptocoin image into its position
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        //this extends its contents to the recycler view, now we have to map all the components in cryptos_row
